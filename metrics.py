...
'''
In these semantics, `y` is defined to be the predicted y, and
`y_` is defined to be the labels
'''
...
def eval_res(gen_n_acc, gen_size, gen_loss_list, y_list, y_list_, use_mcc=True):
