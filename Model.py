        ...
        with tf.name_scope('vmd'):
            with tf.variable_scope('vmd_zh_rec', reuse=tf.AUTO_REUSE):
                ...
                transformer = Transformer(num_layers=2, d_model=512, num_heads=8, dff=2048, 
                    input_vocab_size=8500, target_vocab_size=self.h_size, pe_input=10000, pe_target=6000)
  
                h_s, _ = transformer(x, self.max_n_days, training=True, enc_padding_mask=None, look_ahead_mask=None, dec_padding_mask=None)
